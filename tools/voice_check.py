#!/usr/bin/env python3
"""Flag machine-prose tells in a narrative. Heuristic — a reading aid, not a gate.

Usage:
  python tools/voice_check.py examples/<unit_id>/narrative.md [...]
  python tools/voice_check.py examples/*/narrative.md --summary
